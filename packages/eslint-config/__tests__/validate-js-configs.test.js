...
describe('Validate JS configs', () => {
  it('Validate @buildloop/eslint-config', async () => {
  ...
  it('Validate @buildloop/eslint-config/es5', async () => {
  ...
  it('Validate @buildloop/eslint-config/vue', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential/es5', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential/react', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential/vue', async () => {
  ...
  it('Validate @buildloop/eslint-config/node', async () => {
