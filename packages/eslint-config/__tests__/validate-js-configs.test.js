...
describe('Validate JS configs', () => {
  it('Validate build-loop-eslint-config', async () => {
  ...
  it('Validate build-loop-eslint-config/es5', async () => {
  ...
  it('Validate build-loop-eslint-config/vue', async () => {
  ...
  it('Validate build-loop-eslint-config/essential', async () => {
  ...
  it('Validate build-loop-eslint-config/essential/es5', async () => {
  ...
  it('Validate build-loop-eslint-config/essential/react', async () => {
  ...
  it('Validate build-loop-eslint-config/essential/vue', async () => {
  ...
  it('Validate build-loop-eslint-config/node', async () => {
