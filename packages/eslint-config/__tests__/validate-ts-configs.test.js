...
describe('Validate TS configs', () => {
  it('Validate @buildloop/eslint-config/typescript', async () => {
  ...
  it('Validate @buildloop/eslint-config/typescript/vue', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential/typescript', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate @buildloop/eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate @buildloop/eslint-config/typescript/node', async () => {
