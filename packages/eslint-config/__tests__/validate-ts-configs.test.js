...
describe('Validate TS configs', () => {
  it('Validate build-loop-eslint-config/typescript', async () => {
  ...
  it('Validate build-loop-eslint-config/typescript/vue', async () => {
  ...
  it('Validate build-loop-eslint-config/essential/typescript', async () => {
  ...
  it('Validate build-loop-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate build-loop-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate build-loop-eslint-config/typescript/node', async () => {
